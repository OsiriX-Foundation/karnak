...
import org.karnak.standard.dicominnolitics.ModuleToAttribute;
...
public class StandardModuleToAttributes {
    ...
    private static ModuleToAttribute[] moduleToAttributes;
    ...
    public StandardModuleToAttributes() {
        ...
        try {
            ...
            moduleToAttributes = gson.fromJson(reader, ModuleToAttribute[].class);
        } catch( Exception e) {
            throw new JsonParseException("Cannot parse json SOPS correctly", e);
        }
    }

    public static ModuleToAttribute[] getModuleToAttributes() {
