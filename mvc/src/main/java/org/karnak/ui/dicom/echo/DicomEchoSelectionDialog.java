...
import org.karnak.dicom.model.*;
import org.karnak.dicom.service.DicomNodeManager;
import org.karnak.ui.component.AbstractDialog;
...
public class DicomEchoSelectionDialog extends AbstractDialog {
    ...
    public void selectDicomNoldeList(List<DicomNodeList> nodeLists) {
        try {
            ...
            Message message = new Message(MessageLevel.ERROR, MessageFormat.TEXT, "Cannot read the list of DICOM nodes");
    ...
    private void buildDataProviders() {
        ...
        dataProviderForDicomNodeTypes.addDataProviderListener(new DataProviderListener<DicomNodeList>() {
        ...
        dataProviderForDicomNodes.addDataProviderListener(new DataProviderListener<ConfigNode>() {
    ...
    private void buildDicomNodeTypeSelector() {
        ...
        dicomNodeTypeSelector.addValueChangeListener(new ValueChangeListener<ValueChangeEvent<DicomNodeList>>() {
    ...
    private void buildDicomNodeSelector() {
        ...
        dicomNodeSelector.setItemLabelGenerator(item -> item.getName() + " [" + item.getAet() + " | " + item.getHostname() + " | " + item.getPort() + "]");
    ...
    public class DicomNodeSelectionEvent extends ComponentEvent<DicomEchoSelectionDialog> {
        ...
        private ConfigNode selectedDicomNode;

        public DicomNodeSelectionEvent(DicomEchoSelectionDialog source, boolean fromClient, ConfigNode selectedDicomNode) {
