...
public class TagPatternProfile extends AbstractProfileItem {
    ...
    public TagPatternProfile(String name, String tagPattern, String action, List<String> tags, List<String> exceptedTags) {
        super(name, Objects.requireNonNull(tagPattern).toUpperCase(), action, tags, exceptedTags);
