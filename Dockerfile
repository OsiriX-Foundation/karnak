...
WORKDIR /app
COPY --from=build-stage /mvc/target/karnak-mvc-5.0.0-SNAPSHOT.jar /app/karnak-mvc-5.0.0-SNAPSHOT.jar
EXPOSE 8088

CMD java -Djava.library.path="/tmp/dicom-opencv" -jar /app/karnak-mvc-5.0.0-SNAPSHOT.jar