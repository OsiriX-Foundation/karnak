...
public class EmailConfig {
  ...
  public JavaMailSender getJavaMailSender() {
    ...
    // TODO: add in karnak.env waiting for pull validation => once done test and remove for open
    // source
    ...
    // source
    mailSender.setHost(
        SystemPropertyUtil.retrieveSystemProperty("MAIL_SMTP_HOST", "mailhost.hcuge.ch"));
