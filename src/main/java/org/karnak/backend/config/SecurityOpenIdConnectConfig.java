...
// // Build roles
// return ((List<String>) ((Map<String, Object>) ((Map<String, Object>)
/// jwt.getClaims().get(Token.RESOURCE_ACCESS))
...
// return
/// NimbusJwtDecoder.withJwkSetUri(jwkSetUri).build().decode(accessToken.getTokenValue());
// }
//
// /**
