...
public class DateUtil {
    ...
    public static String getPatientAgeInPeriod(DicomObject dicom, int tag, boolean computeOnlyIfNull) {
        if (dicom == null) {
            return null;
        }
        ...
        LocalDate date = getDate(dicom, Tag.ContentDate, Tag.AcquisitionDate, Tag.DateOfSecondaryCapture,
