...
public class ForwardService {
	...
	public void storeMultipleDestination(ForwardDicomNode fwdNode, List<ForwardDestination> destList, Params p)
			throws IOException {
	...
	public void storeOneDestination(ForwardDicomNode fwdNode, ForwardDestination destination, Params p)
			throws IOException {
	...
	public static synchronized StoreFromStreamSCU prepareTransfer(DicomForwardDestination destination, Params p)
			throws IOException {
	...
	private void monitor(Long forwardNodeId, Long destinationId, Attributes attributesOriginal,
			Attributes attributesToSend, boolean sent, String reason) {
		applicationEventPublisher
				.publishEvent(new TransferMonitoringEvent(TransferStatusEntity.buildTransferStatusEntity(forwardNodeId,
						destinationId, attributesOriginal, attributesToSend, sent, reason)));
	}
