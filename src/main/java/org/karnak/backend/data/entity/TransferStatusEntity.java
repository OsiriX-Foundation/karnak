...
public class TransferStatusEntity implements Serializable {
  ...
  public TransferStatusEntity(
      ...
      boolean sent,
      String reason,
      String patientIdOriginal,
      String accessionNumberOriginal,
      String studyDescriptionOriginal,
      LocalDateTime studyDateOriginal,
      String studyUidOriginal,
      String serieDescriptionOriginal,
      LocalDateTime serieDateOriginal,
      String serieUidOriginal,
      String sopInstanceUidOriginal,
      String patientIdToSend,
      String accessionNumberToSend,
      String studyDescriptionToSend,
      LocalDateTime studyDateToSend,
      String studyUidToSend,
  ...
  public static TransferStatusEntity buildTransferStatusEntity(
    ...
    return new TransferStatusEntity(
        ...
        attributesOriginal.getString(Tag.AccessionNumber),
        attributesOriginal.getString(Tag.StudyDescription),
        DateTimeUtils.dateTime(
            DateUtil.getDicomDate(attributesOriginal.getString(Tag.StudyDate)),
            DateUtil.getDicomTime(attributesOriginal.getString(Tag.StudyTime))),
        attributesOriginal.getString(Tag.StudyInstanceUID),
        attributesOriginal.getString(Tag.SeriesDescription),
        DateTimeUtils.dateTime(
            DateUtil.getDicomDate(attributesOriginal.getString(Tag.SeriesDate)),
            DateUtil.getDicomTime(attributesOriginal.getString(Tag.SeriesTime))),
        attributesOriginal.getString(Tag.SeriesInstanceUID),
        attributesOriginal.getString(Tag.SOPInstanceUID),
        attributesToSend.getString(Tag.PatientID),
        attributesToSend.getString(Tag.AccessionNumber),
        attributesToSend.getString(Tag.StudyDescription),
        DateTimeUtils.dateTime(
            DateUtil.getDicomDate(attributesToSend.getString(Tag.StudyDate)),
            DateUtil.getDicomTime(attributesToSend.getString(Tag.StudyTime))),
        attributesToSend.getString(Tag.StudyInstanceUID),
        attributesToSend.getString(Tag.SeriesDescription),
        DateTimeUtils.dateTime(
  ...
  public boolean equals(Object o) {
    ...
    return sent == that.sent
        ...
        && Objects.equals(patientIdOriginal, that.patientIdOriginal)
