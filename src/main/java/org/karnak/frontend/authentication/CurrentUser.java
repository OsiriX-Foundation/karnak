...
/**
 * Class for retrieving and setting the name of the current user of the current session (without
 * using JAAS). All methods of this class require that a {@link VaadinRequest} is bound to the
 * current thread.
 *
...
public final class CurrentUser {
  ...
  /**
   * Returns the name of the current user stored in the current session, or an empty string if no
   * user name is stored.
   *
  ...
  /**
   * Sets the name of the current user and stores it in the current session. Using a {@code null}
