...
public class ProfileView extends HorizontalLayout {
  ...
  public ProfileView() {
    ...
    profileComponent =
        new ProfileComponent(profilePipeService, profileNameGrid, profileElementMainView);
    ...
    profilePipeSingleSelect.addValueChangeListener(
        e -> {
          ...
          if (profileEntitySelected != null) {
            ...
            profileElementMainView.setProfiles(profileEntitySelected.getProfileElementEntities());
