...
public class WarningConfirmDialog extends Composite<Dialog> {
    ...
    public WarningConfirmDialog(String valueTitle, Div messageLayout, String valueValidate,
        String valueCancel) {
    ...
    public Registration addConfirmationListener(ComponentEventListener<WarningConfirmDialog.ConfirmationEvent> listener) {
