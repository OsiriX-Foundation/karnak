...
class ShiftRangeDateTest {
  ...
  //  //  @Test
  //  void shift() {
  //    byte[] HMAC_KEY = {-116, -11, -20, 53, -37, -94, 64, 103, 63, -89, -108, -70, 84, 43, -74,
  // -8};
  ...
  //    byte[] HMAC_KEY_2 = {-57, -80, 125, -55, 54, 85, 52, 102, 20, -116, -78, -6, 108, 47, -37,
  // -43};
  //    HashContext hashContext_2 = new HashContext(HMAC_KEY_2, Patient_ID_2);
  //    HMAC hmac_2 = new HMAC(hashContext_2);
  //
  //    assertEquals("20171001", ShiftRangeDate.shift(dataset, Tag.StudyDate, argumentEntities,
  // hmac));
  //    assertEquals(
  ...
  //    assertEquals(
  //        "120126.000000", ShiftRangeDate.shift(dataset, Tag.StudyTime, argumentEntities,
  // hmac_2));
  //    assertEquals("043Y", ShiftRangeDate.shift(dataset, Tag.PatientAge, argumentEntities,
  // hmac_2));
  //    assertEquals(
  ...
  //
  //    assertEquals("20170828", ShiftRangeDate.shift(dataset, Tag.StudyDate, argumentEntities,
  // hmac));
  //    assertEquals(
  ...
  //    assertEquals(
  //        "115645.000000", ShiftRangeDate.shift(dataset, Tag.StudyTime, argumentEntities,
  // hmac_2));
  //    assertEquals("043Y", ShiftRangeDate.shift(dataset, Tag.PatientAge, argumentEntities,
  // hmac_2));
  //    assertEquals(
