...
class ProfilesTest {
  ...
  void propagationInSequenceDeletePatientIDButNotInSequence() {
    ...
    DicomElement dicomElemSeq1 =
        dataset1.newDicomSequence(Tag.GroupOfPatientsIdentificationSequence);
    final DicomObject datasetSeq1 = DicomObject.newDicomObject();
    datasetSeq1.setString(Tag.PatientID, VR.LO, "12345");
    DicomElement dicomElemSeq12 =
        datasetSeq1.newDicomSequence(Tag.IssuerOfPatientIDQualifiersSequence);
    ...
    DicomElement dicomElemSeq2 =
        dataset2.newDicomSequence(Tag.GroupOfPatientsIdentificationSequence);
    final DicomObject datasetSeq2 = DicomObject.newDicomObject();
    datasetSeq2.setString(Tag.PatientID, VR.LO, "12345");
    DicomElement dicomElemSeq22 =
        datasetSeq2.newDicomSequence(Tag.IssuerOfPatientIDQualifiersSequence);
  ...
  void propagationInSequence2() {
    ...
    profileElementEntity1.addIncludedTag(
        new IncludedTagEntity("(0010,1010)", profileElementEntity1));
    profileElementEntity1.addIncludedTag(
        new IncludedTagEntity("(0040,0032)", profileElementEntity1));
    final ProfileElementEntity profileElementEntity2 =
        new ProfileElementEntity(
            "Keep tag", "action.on.specific.tags", null, "K", null, 0, profileEntity);
    profileElementEntity2.addIncludedTag(
  ...
  void propagationInSequence3() {
    ...
    final ProfileElementEntity profileElementEntity1 =
        new ProfileElementEntity(
            "Shift Date with argumentEntities",
            "action.on.dates",
            null,
            null,
            "shift",
            ...
            profileEntity);
    profileElementEntity1.addIncludedTag(
        new IncludedTagEntity("(xxxx,xxxx)", profileElementEntity1));
  ...
  void propagationInSequence4() {
    ...
    final DicomObject datasetSeq2 = DicomObject.newDicomObject();
    datasetSeq2.setString(
        Tag.ReferencedSOPClassUID, VR.UI, "2.25.278659998382609075216063956388837522977");
    datasetSeq2.setString(
        Tag.ReferencedFrameNumber, VR.UI, "2.25.278659998382609075216063956388837522977");
    ...
    datasetSeq22.setString(
        Tag.CodingSchemeDesignator, VR.UI, "2.25.313557030369376654019214873435380124495");
    dicomElemSeq22.addItem(datasetSeq22);
    ...
    final ProfileElementEntity profileElementEntity1 =
        new ProfileElementEntity(
            "UID", "action.on.specific.tags", null, "U", null, 0, profileEntity);
    profileElementEntity1.addIncludedTag(
