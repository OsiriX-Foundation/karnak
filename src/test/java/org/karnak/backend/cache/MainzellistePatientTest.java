...
class MainzellistePatientTest {
	...
	protected static void setUpBeforeClass() throws Exception {
		mainzellistePatient = new Patient("pseudonym", "mykasa", "Kenny", "Ackermann", LocalDate.of(1982, 2, 4), "M",
				"DPA");
		mainzellistePatientWithFirstName = new Patient("pseudonym", "mykasa", "Kenny", "", LocalDate.of(1982, 2, 4),
				"M", "DPA");
		mainzellistePatientWithLastName = new Patient("pseudonym", "mykasa", "", "Ackermann", LocalDate.of(1982, 2, 4),
				"M", "DPA");
		mainzellistePatientWithLastNameNull = new Patient("pseudonym", "mykasa", "Kenny", null,
				LocalDate.of(1982, 2, 4), "M", "DPA");
		mainzellistePatientWithFirstNameNull = new Patient("pseudonym", "mykasa", null, "Ackermann",
				LocalDate.of(1982, 2, 4), "M", "DPA");
	}

	private static Stream<Arguments> providerGetPatientName() {
		return Stream.of(Arguments.of(mainzellistePatient, "Ackermann^Kenny"),
	...
	private static Stream<Arguments> providerGetPatientFirstName() {
		return Stream.of(Arguments.of(mainzellistePatient, "Kenny"),
				Arguments.of(mainzellistePatientWithFirstName, "Kenny"),
	...
	private static Stream<Arguments> providerGetPatientLastName() {
		return Stream.of(Arguments.of(mainzellistePatient, "Ackermann"),
	...
	private static Stream<Arguments> providerUpdatePatientLastName() {
		...
		return Stream.of(Arguments.of(mainzellistePatient, "Katshan"),
				Arguments.of(mainzellistePatientWithFirstName, ""),
	...
	private static Stream<Arguments> providerUpdatePatientFirstName() {
		...
		return Stream.of(Arguments.of(mainzellistePatient, "Bakugo"),
	...
	private static Stream<Arguments> providerUpdatePatientName() {
		...
		mainzellistePatientWithFirstNameNull.setPatientLastName("Katshan");
		mainzellistePatientWithFirstNameNull.setPatientFirstName(null);
		return Stream.of(Arguments.of(mainzellistePatient, "Katshan^Bakugo"),
				Arguments.of(mainzellistePatientWithFirstName, "^Bakugo"),
				Arguments.of(mainzellistePatientWithLastName, "Katshan"),
				Arguments.of(mainzellistePatientWithLastNameNull, "^Bakugo"),
				Arguments.of(mainzellistePatientWithFirstNameNull, "Katshan"));
	...
	void getUpdatedPatientLastName(Patient mainzellistePatient, String output) {
		assertEquals(mainzellistePatient.getPatientLastName() == null ? "" : mainzellistePatient.getPatientLastName(),
				output);
	}
	...
	void getUpdatedPatientFirstName(Patient mainzellistePatient, String output) {
		assertEquals(mainzellistePatient.getPatientFirstName() == null ? "" : mainzellistePatient.getPatientFirstName(),
				output);
	}
