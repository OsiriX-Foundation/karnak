...
public class GatewayPersistenceTest {
    ...
    private final Consumer<Destination> destinationDicomConsumer = //
        x -> assertThat(x) //
            .hasFieldOrPropertyWithValue("description", "description") //
    ...
    private final Consumer<Destination> destinationStowConsumer = //
        x -> assertThat(x) //
            .hasFieldOrPropertyWithValue("description", "description") //
